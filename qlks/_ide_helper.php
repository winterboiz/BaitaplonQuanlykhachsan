 ...
 * Generated for Laravel 5.7.13 on 2019-03-27 09:05:45.
 *
...
namespace App\Khanhvuht\Facades { 
    ...
    class Tool {
        ...
        {
                        /** @var \App\Khanhvuht\ToolFactory $instance */
                        return $instance->getThumbnail($filename, $suffix);
        }
         ...
         * @static 
         */ 
        public static function getCurrencyVN($number, $symbol = 'VND', $isPrefix = false)
        {
                        /** @var \App\Khanhvuht\ToolFactory $instance */
                        return $instance->getCurrencyVN($number, $symbol, $isPrefix);
        }
